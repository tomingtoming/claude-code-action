...
## Fork Changes (tomingtoming/claude-code-action@beta)
...
- **Updated Base Action**: Uses `tomingtoming/claude-code-base-action@beta` which includes OAuth credential handling
